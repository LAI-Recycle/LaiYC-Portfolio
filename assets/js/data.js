...
var PORTFOLIO = {
    ...
    about: {
        ...
        values: [
            ...
            { title: '方法導向',     desc: '企業需要的是從最底層的需求出發、思考架構並跨部門溝通規劃。' },
    ...
    beliefs: {
        items: [
            {
                title: '組織需要的是思考需求是什麼，從哪裡導入 ',
                desc:  '真正的挑戰在於需求出發、思考架構並跨部門溝通規劃。'
            },
            {
                title: '從單點推到找到槓桿整個系統',
                desc:  '局部優化是讓支撐跨部門流程協作與組織學習的第一步。'
            },
            {
                title: '技術與業務間的語言不同，但要跨思維的理解、採用與落地，才算真正產生價值',
    ...
    projects: [
        ...
        },
        {
            ...
            impact: { value: '68K+', desc: '累積瀏覽 · 64 篇' }
        },
        {
            n: '06',
    ...
    community: {
        items: [
            ...
            },
            {
                                ...
                                year: '2019',
                title: '成大單車節總召集人',
                desc: '統籌大型活動、跨單位協調與團隊管理，培養整合資訊推動行動的能力。'
            }
        ]
    },
